public class ShadyStunedState : EnemyState
{
    Enemy_Shady enemy;
    public ShadyStunedState(EnemyStateMachine stateMachine, Enemy enemyBase, string animBoolName, Enemy_Shady enemy) : base(stateMachine, enemyBase, animBoolName)
    {
        this.enemy = enemy;
    }
