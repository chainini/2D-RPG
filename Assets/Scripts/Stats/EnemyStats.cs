...
public class EnemyStats : CharacterStats
{
    ...
    private void ApplyLevelStatModifier()
    {
        Modify(strength);
        Modify(agility);
        Modify(intelligence);
    ...
    protected override void DecreaseHealthBy(float _damage)
    {
        ...
        {
            enemy.SetupKnockBackPower(new Vector2(20, 9));
            enemy.entityFX.ScreenShake(new Vector3(enemy.entityFX.shakeHighDamage.x, enemy.entityFX.shakeHighDamage.y));
